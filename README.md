...
```bash
git clone https://github.com/hyperwaspstove/shelly-1-gen4-matter-thread-282.git
cd shelly-1-gen4-matter-thread-282
...
Have a firmware variant or feature you'd like to see prioritized? [Vote on the roadmap discussion](https://github.com/hyperwaspstove/shelly-1-gen4-matter-thread-282/discussions) or open an issue with your use case.
...
<!-- Last updated: 2026-06-06 14:49:05 -->
